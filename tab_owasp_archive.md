...
The MCP Top 10 is a standard awareness document that intends to provide risks around MCP server and client with insight into the top 10 vulnerabilities found in MCP. 
